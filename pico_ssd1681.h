 ...
 * @return 0 on success
 */
int ssd1681_draw_string(ssd1681_color_t color, uint8_t x, uint8_t y, const char *str, uint16_t len, uint8_t data, uint8_t font);
 ...
 * @return 0 on success
 */
int ssd1681_fill_rect(ssd1681_color_t color, uint8_t left, uint8_t top, uint8_t right, uint8_t bottom, uint8_t data);
...
#if defined(PICO_SSD1681_IMPLEMENTATION)
/**
 * SSD1681 E-Paper Display Driver for Raspberry Pi Pico
 * Direct Pico SDK implementation - no HAL abstraction
 * 
...
#include "pico_ssd1681_font_data.h"
...
#define SSD1681_DATA_ENTRY_XY_INCREMENT 0x03
...
#endif /* PICO_SSD1681_IMPLEMENTATION */
#endif /* PICO_SSD1681_H */
